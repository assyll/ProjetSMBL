...
public interface StateMemory {
	...
	public void setRequestMessage(RequestMessage msg); //Message de requete reï¿½u (mit ï¿½ jour par la phase de perception)
	public void setResponseMessage(ResponseMessage msg); //Message de rï¿½ponse ï¿½ une requï¿½te reï¿½u (mit ï¿½ jour par la phase de perception)
	public RequestMessage getRequestMessage(); // Rï¿½cupï¿½ration de la requï¿½te
	public ResponseMessage getResponseMessage(); // Rï¿½cupï¿½ration de la rï¿½ponse
	
	public void setIsRoot(boolean isRoot);
	public void setWaitingForTraceElmt(boolean b); // pour savoir au prochaine cycle si on doit essayer de rï¿½cupï¿½rer un ï¿½lï¿½ment de trace ou pas
	public void setWaitingForResponse(boolean b); // en attente d'une rï¿½ponse ï¿½ une requï¿½te ï¿½mise 
	public boolean isWaitingForTraceElmt(); // Rï¿½cupï¿½rer l'information "attente d'un ï¿½lï¿½ment de trace"
	public boolean hasGotRequestMessage(); // Rï¿½cupï¿½rer l'information "reception d'une requï¿½te en attente de traitement"
	public boolean hasGotResponseMessage();// Rï¿½cupï¿½rer l'information "reception d'une rï¿½ponse en attente de traitement"
