...
public class CustomGraphRenderer {
	...
	public static void setStyleGraphDoubleCircle(Graph graph) {
	...
	public static void setStyleGraphRobot(Graph graph) {
		graph.addAttribute("ui.quality");
		graph.addAttribute("ui.antialias");
		graph.addAttribute(
				"ui.stylesheet",
	...
	public static void setStyleGraphBasic(Graph graph) {
		graph.addAttribute("ui.quality");
		graph.addAttribute("ui.antialias");
		graph.addAttribute(
				"ui.stylesheet",
