...
public void testGenerateJson() {
		...
		MyJsonNode n5 = new MyJsonNode("node 5", false, false, new LinkedList<String>());
		MyJsonNode n6 = new MyJsonNode("node 6", false, false, new LinkedList<String>());
		MyJsonNode n7 = new MyJsonNode("node 7", false, false, new LinkedList<String>());
		MyJsonNode n8 = new MyJsonNode("node 8", false, false, new LinkedList<String>());
		MyJsonNode n9 = new MyJsonNode("node 9", false, false, new LinkedList<String>());
		MyJsonNode n10 = new MyJsonNode("node 10", false, false, new LinkedList<String>());
